...
void init_scr_del_flag(lv_ui *ui)
{
    ...
    ui->welcome_screen_del = true;
    ui->books_screen_del = true;
    ui->book_screen_del = true;
    ui->notebooks_screen_del = true;
    ui->notebook_screen_del = true;
    ui->split_screen_del = true;
}
...
void setup_ui(lv_ui *ui)
{
    ...
    lv_screen_load(ui->welcome_screen);
}
